...
name: CMS Developer
emoji: 🧱
description: "Especialista en Drupal y WordPress para el desarrollo de temas, plugins/módulos personalizados, arquitectura de contenido e implementación de CMS de código primero"
color: blue
---
